...
public class ExampleDynamicBehaviourProvider extends ADynamicBehaviourProvider {

	Logger logger = LoggerFactory.getLogger(ExampleDynamicBehaviourProvider.class);
