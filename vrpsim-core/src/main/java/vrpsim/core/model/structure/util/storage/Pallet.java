...
public class Pallet implements ICanStore, IStorable {

	final String storableId;
	final CanStoreParameters canStoreParameters;
	final StorableParameters storableParameters;

	public Pallet(final String storableId, final CanStoreParameters canStoreParameters,
			final StorableParameters storableParameters) {
