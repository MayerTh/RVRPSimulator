...
public class Structure {
	...
	public void reset() {
		depots.stream().forEach(d -> d.reset());
		customers.stream().forEach(d -> d.reset());
		vehicles.stream().forEach(d -> d.reset());
		drivers.stream().forEach(d -> d.reset());
		occasionalDrivers.stream().forEach(d -> d.reset());
	}
	/**
