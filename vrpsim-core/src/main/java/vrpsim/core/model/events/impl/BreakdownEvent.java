...
public class BreakdownEvent implements IEvent {
	...
	public BreakdownEvent(IEventOwner owner, IEventType type, Integer priority, Double relativeTimeTillOccurence) {
		this.owner = owner;
		this.type = type;
