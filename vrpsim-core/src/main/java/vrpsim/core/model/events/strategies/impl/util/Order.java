...
public class Order extends Observable {
	...
	private final Long earliestDueDate;
	/* latest due date of the order. */
	private final Long latestDueDate;
	/* What is ordered. */
	 ...
	 * @param initialCots
	 */
	public Order(String id, Long earliestDueDate, Long latestDueDate, StorableParameters storableParameters, int amount,
