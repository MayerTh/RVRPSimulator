...
public class RModel {
	...
	private final RPoint min;

	private final boolean pointsAreConnected;

	public RModel(RPoint start, List<RPoint> ListOfPoints, RPoint end, RPoint max, RPoint min, boolean pointsAreConnected) {
		super();
		this.start = start;
