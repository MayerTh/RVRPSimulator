...
public interface IDynamicVRPREPModelInstanceGenerator {
	...
	public IDynamicVRPREPModelGenerationPosibilities generateStatisticInformation(double degreeOfDynanism, int numberCombinationsGenerationPosibilitiesAreBasedOn)
	...
	public DynamicVRPREPModel generateInstance(TmpRequests dynamicRequests, IDynamicVRPREPModelGenerationPosibilities posibilities,
			IArrivalTimeDetermineStrategy arrivalTimeDetermineStrategy, double edod, int timeHorizon) throws InstanceGenerationException;
