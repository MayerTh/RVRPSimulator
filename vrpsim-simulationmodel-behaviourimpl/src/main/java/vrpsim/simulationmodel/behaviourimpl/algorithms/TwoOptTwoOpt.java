...
import vrpsim.simulationmodel.dynamicbehaviour.impl.TwoOptDynamic;
...
public class TwoOptTwoOpt extends AAlgorithm {

	private final long seed;

	public TwoOptTwoOpt(long seed) {
		this.seed = seed;
	}
	...
	public void handleDynamicOrder(List<TourState> currentTourStates, TourActivity newOrder, IClock clock, StructureService structureService,
		...
		// Dynamic Problem
		new TwoOptDynamic(this.seed).hanldeOrder(currentTourStates, newOrder, clock, structureService, networkService);
	}
