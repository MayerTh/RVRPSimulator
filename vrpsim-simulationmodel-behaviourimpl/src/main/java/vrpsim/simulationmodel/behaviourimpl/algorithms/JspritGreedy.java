...
import vrpsim.simulationmodel.initialbehaviour.simpleapi.impl.jsprit.Jsprit;

public class JspritGreedy extends AAlgorithm {
	...
	public List<TourAPI> handleOrder(List<VehicleAPI> vehicles, List<CustomerAPI> customers, List<DepotAPI> depots,
		...
		// Static problem
		return new Jsprit().handleOrder(vehicles, customers, depots, drivers);
	}
