...
/**
 * The Location based Degree of Dynanism from Mayer, T., Uhlig, T. & Rose, o. (2017),
 * ‘A Location Model for Dynamic Vehicle Routing Problems.’
 * 
 * @author mayert
 *
 */
public class OWN_WLDOD extends ADynamicModelFeature {
	...
	public Map<String, Double> calculateDynamicFeature(DynamicVRPREPModel model) {
		...
		result.put(this.getIdentifier(), (dynamicDistance / totalDistance) * weight);
		return result;
	}
