...
public class OWN_DynamicToStaticNNearestNeighborsAngleMax extends ADynamicModelFeature {

	private static Logger logger = LoggerFactory.getLogger(OWN_DynamicToStaticNNearestNeighborsAngleMax.class);
	private final int numberNeighbors;

	@Override
	public String getIdentifier() {
		return this.numberNeighbors + "NNAngleMax";
	}
	 ...
	 */
	public OWN_DynamicToStaticNNearestNeighborsAngleMax(int numberNeighbors) {
