...
public class OWN_DynamicToStaticNNearestNeighborsAngleSum extends ADynamicModelFeature {

	private static Logger logger = LoggerFactory.getLogger(OWN_DynamicToStaticNNearestNeighborsAngleSum.class);
	private final int numberNeighbors;

	@Override
	public String getIdentifier() {
		return this.numberNeighbors + "NNAngleSum";
	}
	 ...
	 */
	public OWN_DynamicToStaticNNearestNeighborsAngleSum(int numberNeighbors) {
